    ...
    <nav className="bg-hero/95 backdrop-blur-md border-b border-stat-border sticky top-0 z-50">
      <div className="container flex items-center justify-between h-16">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-hero-foreground">MailPro</span>
        </div>
        ...
        <Button size="sm" className="bg-gradient-primary text-primary-foreground rounded-lg hover:opacity-90 transition-opacity">
          문의하기
        </Button>
      </div>
    </nav>
